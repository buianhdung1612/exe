    ...
    return (
        <div className="bg-[#fff0f0] rounded-[20px] overflow-hidden product-item transition-all duration-300 ease-linear hover:bg-client-primary group">
            <div className="p-[15px]">
                <div className="relative rounded-[20px] overflow-hidden aspect-[327/343]">
                    {/*Primary Image */}
                    <img
            ...
            <div className="grid grid-cols-[1fr_auto] gap-[20px]">
                <div className="pl-[30px] mb-[20px]">
                    ...
                    <Link
                        to="/"
                        className="inline-block text-client-secondary text-[2.4rem] 2xl:text-[2.3rem] font-secondary leading-[1.8] transition-all duration-[350ms] ease-in-out my-[10px] group-hover:text-white hover:opacity-70"
                    >
                        {product.title}
                    </Link>

                    {/* Price */}
                    <p className="text-client-secondary group-hover:text-white transition-colors duration-300 ease-linear">
                        {product.price}
                    </p>
                </div>
