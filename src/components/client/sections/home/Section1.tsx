                    ...
                    <section className="text-white pl-[80px] w-[50%] relative section-1-left">
                        ...
                        <div className="flex gap-[30px]">
                            {/* <div className="relative inline-block min-w-[142px] group outside-button">
                                <Link
                                    to="/"
                                    className="inline-block relative mask-[url('/mask-bg-button.svg')] mask-no-repeat mask-center mask-[size:100%] rounded-[10px] bg-white px-[30px] py-[12px] text-[1.5rem] font-secondary text-client-secondary hover:text-white button-text transition-all duration-300 linear"
                                >
                                    Xem thêm
                                </Link>
                                <svg fill="currentColor" className="w-[1.6rem] h-[1.6rem] absolute right-[-5px] top-[-6px] group-hover:text-client-secondary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 20" xmlSpace="preserve">
