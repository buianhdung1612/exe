        ...
        <section className="relative px-[30px] py-[150px] bg-white">
            <div className="app-container flex gap-[30px]">
                ...
                >
                    ...
                    <div className="w-[50%] py-[40px]">
                        ...
                        <div className="relative inline-block min-w-[142px] outside-button-more">
                            ...
                            <svg fill="#fff" className="w-[1.6rem] h-[1.6rem] absolute right-[-10px] top-[-6px] svg-section-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 20" xmlSpace="preserve">
                ...
                >
                    ...
                    <div className="section-4-sale bg-white absolute top-[10px] right-[15px] w-[136px] h-[133px] text-[3.2rem] font-secondary text-client-secondary flex items-center justify-center">
                        40% OFF
                    </div>
                </div>
            </div>
